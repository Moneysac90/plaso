...
class CiscoASA(events.EventData):
  ...
  DATA_TYPE = 'cisco_asa:user_access_logging:entry'

  def __init__(self):
    """Initializes event data."""
    super(CiscoASA, self).__init__(data_type=self.DATA_TYPE)
...
class CiscoASATextPlugin(interface.TextPlugin):
  """Text parser plugin for Cisco ASA log files."""

  NAME = 'cisco_asa'
  DATA_FORMAT = 'Cisco ASA log (access.log) file'
...
text_parser.TextLogParser.RegisterPlugin(CiscoASA)
